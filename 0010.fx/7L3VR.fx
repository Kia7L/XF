...
[]	{
		...
		float (MIXREALITY.PORTAL.OCULUS.CONTROLLER.MOUSE.VR.VIRUTUALREALITY.1)*yy=ScaleSens<((xx,yy)<-Sens>0x0FF>0x0F>0xF10),ScaleSens<((xx,yy)<-Sens>0x0FF>0x0F>0xF10)*xx 0 1110
